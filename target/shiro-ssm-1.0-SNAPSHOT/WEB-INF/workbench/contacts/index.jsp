        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group" style="position: relative;">
                        <label for="create-contactsName" class="col-sm-2 control-label">客户名称</label>
                        <div class="col-sm-10" style="width: 300px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="edit-contactsName" class="col-sm-2 control-label">客户名称</label>
                        <div class="col-sm-10" style="width: 300px;">
...
<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar" style="height: 80px;">
            <form class="form-inline" role="form" style="position: relative;top: -10%; left: 5px;">
            ...
            function (data) {
                ...
                $.each(data.list, function (index, item) {
                    ...
                    $("#contactsList").append(`<tr class="active" >
                                    ...
                                    onclick='contacts_detail(` + str + `)'>` + item.fullName + `</a></td>
