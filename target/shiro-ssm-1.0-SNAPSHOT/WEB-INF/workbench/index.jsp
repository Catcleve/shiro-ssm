...
<head>
    ...
    <script type="text/javascript" src="/shiro/jquery/ajaxfileupload.js"></script>
        ...
        $(function () {
            ...
            window.open("/shiro/toView/workbench/main/index", "workareaFrame");
...
<div class="modal fade" id="exitModal" role="dialog">
    <div class="modal-dialog" role="document" style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="location.href='/shiro/user/logout'">确定</button>
            </div>
        </div>
    </div>
</div>
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            <li class="liClass"><a href="/shiro/toView/workbench/main/index" target="workareaFrame"><span
                    class="glyphicon glyphicon-home"></span> 工作台</a></li>

            <c:forEach items="${user.permissions}" var="permission">
                <c:choose >
                    <c:when test="${permission.children != null}">
                <li class="liClass">
                    ...
                    <ul id="no2" class="nav nav-pills nav-stacked collapse">
                        <c:forEach items="${permission.children}" var="child">
                            <li class="liClass"><a href="${child.url}" target="workareaFrame">&nbsp;&nbsp;&nbsp;
                                <span class="glyphicon glyphicon-chevron-right"></span> ${child.PName}</a></li>
                        </c:forEach>
                    </ul>
                </li>
                    </c:when>
                    <c:otherwise>
                        <li class="liClass">
                            <a href="${permission.url}" target="workareaFrame">
                                <span class="glyphicon glyphicon-home"></span>  ${permission.PName}</a>
                        </li>
                    </c:otherwise>
                </c:choose>
         ...
         <%--   <li class="liClass"><a href="javascript:void(0);" target="workareaFrame"><span
            ...
            <li class="liClass"><a href="/shiro/toView/workbench/activity/index" target="workareaFrame"><span
                    class="glyphicon glyphicon-play-circle"></span> 市场活动</a></li>
            <li class="liClass"><a href="/shiro/toView/workbench/clue/index" target="workareaFrame"><span
                    class="glyphicon glyphicon-search"></span> 线索（潜在客户）</a></li>
            <li class="liClass"><a href="/shiro/toView/workbench/customer/index" target="workareaFrame"><span
                    class="glyphicon glyphicon-user"></span> 客户</a></li>
            <li class="liClass"><a href="/shiro/toView/workbench/contacts/index" target="workareaFrame"><span
                    class="glyphicon glyphicon-earphone"></span> 联系人</a></li>
            <li class="liClass"><a href="/shiro/toView/workbench/transaction/index" target="workareaFrame"><span
                    class="glyphicon glyphicon-usd"></span> 交易（商机）</a></li>
            <li class="liClass"><a href="/shiro/toView/workbench/visit/index" target="workareaFrame"><span
            ...
            <%--<li class="liClass">
                ...
                <ul id="no2" class="nav nav-pills nav-stacked collapse">
                    ...
                    <li class="liClass"><a href="/shiro/toView/workbench/chart/clue/index" target="workareaFrame">&nbsp;&nbsp;&nbsp;
                    ...
                    <li class="liClass"><a href="/shiro/toView/workbench/chart/transaction/index" target="workareaFrame">&nbsp;&nbsp;&nbsp;
